let allFunctions = {
    createElement(tagName, parentName) {
        let child = "";
    ...
    createComment(parent, textareaValues) {
    ...
    replyComments(e) {
        editFunction(e.target.closest(".likeReplyContainer"));
        return true;
    },
    content(textareaValues, message) {
    ...
    seeMoreLess(textareaValuesText) {
        let moreLess = "";
    ...
    editFunction(deleteContainer, editEdit = "") {
    ...
    seeLessSeeMoreText(totalLongText) {
    ...
    appendingSubmitComment(e, replyTextarea) {
        let target = "", parent = "", commentListChild = "";
    ...
    likePictureShow(e) {
        let likeImage = "", likeCountContainer = "", likeCount = "", likeCountNumber = "";
        if (e.target.nextSibling == null) {
            ...
            likeCountContainer = createElement("span", e.target.parentElement);
            likeCountContainer.setAttribute("class", "likeCountContainer");
            likeCountContainer.innerText = "1";

            likeCount = e.target.parentElement.querySelector(".likeCountContainer").innerText;
...
function newTextareaValue() {
    textarea.value.length > 0 ? allFunctions.createComment(commentsList, textarea.value) : alert("Please Enter some comments in Text Box");
}

    ...
    if (selectedCountryName !== "") {
        $.ajax({
            ...
            success: function (result) {
                ...
                function removeDuplicates(responseText) {
                    return responseText.filter((item, index) => responseText.indexOf(item) === index);
                }
                ...
                // removeDuplicates removes duplicate values using filter methods
                let uniqueResponseText = removeDuplicates(responseText);
